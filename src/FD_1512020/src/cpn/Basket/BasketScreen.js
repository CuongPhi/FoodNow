...
const styles = StyleSheet.create({
  wrapper: {
    flex: 10,
    backgroundColor: Color.PColor.city_light(1),
  },
  text1: {
  ...
  render() {
    ...
    return (
      <View style={[main, { backgroundColor: Color.PColor.city_light(1) }]}>
        <Header
          leftComponent={
            <Icon name="times-circle" color={Color.PColor.dracula_orchid(1)} size={20} />
          }
          centerComponent={
            <Text
              style={{
          ...
          rightComponent={<Icon name="sync-alt" color={Color.PColor.dracula_orchid(1)} size={20} />}
          backgroundColor="white"
        />
        <View style={wrapper}>
          <ScrollView>
